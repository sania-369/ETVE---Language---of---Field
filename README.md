...
- [Проверка модели на отношениях масс](ETVE_Mass_Relations_Check.md)
Эти документы показывают, что ЕТВП — не просто «красивая идея», а вычислимая модель. Константы, массы и радиусы возникают из топологии поля, а не вводятся вручную. Любой может проверить выводы и убедиться, что они согласуются с экспериментом с точностью > 99%.
