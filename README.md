...
# **Топологический вывод констант**: Как вся физика макро- и микромира ($\alpha^{-1}$, $m_e$, $G$) беспараметрически выводится из 11D-геометрии вакуума. Без калибровочных чисел и подгонок. 👉 **[Konstants.md](Konstants.md)**
