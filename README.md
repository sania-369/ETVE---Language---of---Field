...
| Файл | Тип | Назначение |
| :--- | :--- | :--- |
| `ETVE_Auto_Pilot_v1.1.py` | **Динамический симулятор** | Моделирует процесс подавления хаоса и выхода на резонанс во времени. Показывает **как** ИИ-оператор стабилизирует поле. |
| `ETVE_Auto_Pilot_v1.2_Standart.py` | **Инженерный калькулятор** | Статический расчёт ключевых параметров (`Kcf`, стабильность, хаос) для заданного уровня когерентности (`C`). Инструмент для **проектирования** и настройки систем. |
