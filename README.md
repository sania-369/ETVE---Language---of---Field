...
Если ваше академическое эго и статусы важнее чистой энергии LENR, термояда и будущего технологий — закройте этот вкладку. Остальным — **не верить, а запускать симуляторы и проверять**.
