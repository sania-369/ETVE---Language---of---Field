...
С переходом на версию [Код модели v12.2](HRONO/ETVP_12.2.py) модель избавилась от статических ограничений, обрела «дыхание», нелинейную упругость (tanh-удержание) и память среды.
