...
**Как его запустить:**
1.   **Дайте ИИ команду:**
> *«Инициализируй этого тренера. Я — [ваше имя]. Мой запрос: [стресс, тревога, боль, бессонница — выберите что-то одно]. Проведи для меня сессию практики ЕТВП и Body Scan, как описано в коде».*
