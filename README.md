...
📂 **Где искать файлы синтеза:** Переключитесь на ветку [theory-of-modes](https://github.com/sania-369/ETVE---Language---of---Field/tree/Теория-Мод) и ищите в архиве модулей теории мод. Это ядро необходимо для интеграции «дыхания полей» в кастомные слои нейросетей (PyTorch/GPU).
