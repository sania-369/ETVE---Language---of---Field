...
* С переходом на версию [Код модели v12.3](HRONO/ETVP_12.3.py) модель избавилась от статических ограничений, обрела «дыхание», нелинейную упругость (tanh-удержание) и память среды.
